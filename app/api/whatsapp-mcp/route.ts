...
const INITIAL_MOCK_MESSAGES: Record<string, any[]> = {
  "123456789@s.whatsapp.net": [
    { key: { id: "wmsg_1", remoteJid: "123456789@s.whatsapp.net", fromMe: false }, pushName: "Sarah Jenkins", message: { conversation: "Hi Manav, did you check the NDA terms I sent via email?" }, messageTimestamp: Math.floor(Date.now() / 1000) - 3600 },
    { key: { id: "wmsg_2", remoteJid: "123456789@s.whatsapp.net", fromMe: true }, pushName: "Manav", message: { conversation: "Hey Sarah! Just saw them. I will review and get back to you within 2 days." }, messageTimestamp: Math.floor(Date.now() / 1000) - 3000 },
  ...
  "987654321@s.whatsapp.net": [
    ...
    { key: { id: "wmsg_5", remoteJid: "987654321@s.whatsapp.net", fromMe: true }, pushName: "Manav", message: { conversation: "Yes, definitely! Downtown office Starbucks works for me." }, messageTimestamp: Math.floor(Date.now() / 1000) - 7000 },
  ...
  "111222333@s.whatsapp.net": [
    { key: { id: "wmsg_7", remoteJid: "111222333@s.whatsapp.net", fromMe: false }, pushName: "John Doe", message: { conversation: "Hey Manav, don't forget to submit the Q2 presentation slides by 4:45 PM today." }, messageTimestamp: Math.floor(Date.now() / 1000) - 14400 },
    { key: { id: "wmsg_8", remoteJid: "111222333@s.whatsapp.net", fromMe: true }, pushName: "Manav", message: { conversation: "Sure John, compiling the final draft now. Will send it shortly." }, messageTimestamp: Math.floor(Date.now() / 1000) - 14000 }
  ],
  "120363024555555555@g.us": [
    ...
    { key: { id: "wmsg_10", remoteJid: "120363024555555555@g.us", fromMe: false }, pushName: "Sarah Jenkins", message: { conversation: "I've reviewed the budget part. Just waiting on Manav's Q2 slides." }, messageTimestamp: Math.floor(Date.now() / 1000) - 5200 },
    { key: { id: "wmsg_11", remoteJid: "120363024555555555@g.us", fromMe: false }, pushName: "John Doe", message: { conversation: "Yes, Manav said he is sending them by 4:45 PM today." }, messageTimestamp: Math.floor(Date.now() / 1000) - 5000 }
  ]
};
        ...
        case "whatsapp_summarize_conversations": {
          ...
          if (chatId) {
            ...
            if (chatId === "123456789@s.whatsapp.net") {
              summary = `Sarah Jenkins requested feedback on the NDA terms via email. Manav replied that he is reviewing them and will finalize within 2 days. Sarah proposed meeting for lunch tomorrow to sync.`;
            } else if (chatId === "987654321@s.whatsapp.net") {
              summary = `Alex Rivera asked if the coffee meeting tomorrow at 4:30 PM is still on. Manav confirmed the Starbucks location. Alex noted he wants to discuss the technical roadmap and milestones.`;
            } else if (chatId === "111222333@s.whatsapp.net") {
              summary = `John Doe reminded Manav to submit the Q2 presentation slides by 4:45 PM today. Manav confirmed compilation is in progress and he will send them shortly.`;
            } else if (chatId === "120363024555555555@g.us") {
              summary = `Marketing Launch Team sync: Alex Rivera asked if slides are ready. Sarah Jenkins reviewed her budget portion and is waiting on Manav. John Doe confirmed Manav will send the slides by 4:45 PM today.`;
            } else {
            ...
            summary = `Orbit Daily WhatsApp Brief:\n` +
              ...
              `4. Marketing Launch Team Group: Awaiting slides from Manav to finalize campaign presentation tomorrow.`;
          }
